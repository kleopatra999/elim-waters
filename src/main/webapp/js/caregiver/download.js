function downloadcaregivers(){
	$.ajax({
		type: "GET",
		url: '/elim/rest/caregivers/download/xls',
...
function getSelectedcaregivers(){
...
require(["dataTables","caregiver/deleteCaregiver"], function() {
	$(document).ready(function() {
		
		$('#caregiver-data-list').dataTable({
